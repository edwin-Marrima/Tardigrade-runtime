...
LATEST_RELEASE_URL="https://github.com/edwin-Marrima/Tardigrade-runtime/releases/latest"
...
RELEASE_URL="https://github.com/edwin-Marrima/Tardigrade-runtime/releases/download/$RELEASE_TAG"
...
display_version_info() {
  ...
  if [ -f "$version_file" ]; then
    ...
    print_message "https://github.com/edwin-Marrima/Tardigrade-runtime/releases/latest"
  else
...
curl -L -o "$INSTALL_IMAGES_SCRIPT" "https://raw.githubusercontent.com/edwin-Marrima/Tardigrade-runtime/main/setup/install-images.py"
